...
-- Q4. Display all records from every table
...
-- Q5. Describe the structure of Apps table
...
-- Q1. Insert a new developer named OpenAI
-- Country = USA
-- FoundedYear = 2015
...
-- Q2. Insert Artificial Intelligence category
-- MinimumAge = 12
...
-- Q4. Update Temple Run rating from 4.2 to 4.5
...
-- Q5. Delete developer whose DeveloperID = 105
...
-- Q1. Change Samsung Galaxy Store support email
...
-- Q2. Insert two new applications
...
-- Q3. Update BYJU'S Learning price from 299 to 199
...
-- Q4. Delete Music category

DELETE FROM Categories
WHERE CategoryID = 303;


-- Q5. Display final records from all four tables
